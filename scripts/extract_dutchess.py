...
DEPRECATED: Use fetch_results.py instead.
    ...
    python scripts/fetch_results.py --county dutchess
...
def main():
    ...
    print("Use: python scripts/fetch_results.py --county dutchess")
    print("=" * 60)
    print()

    subprocess.run([sys.executable, "scripts/fetch_results.py", "--county", "dutchess"])
