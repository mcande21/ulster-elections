#!/usr/bin/env python3
"""
Extract election results from Dutchess County 2025 PDF.

Handles fusion voting (multiple party lines per candidate) and various
formatting patterns across 66 pages.
"""
    ...
    with pdfplumber.open(pdf_path) as pdf:
        for page in pdf.pages:
            ...
            for i, line in enumerate(lines):
                ...
                if not line or 'Dutchess County Summary' in line or '2025 General Election' in line:
                    continue
                ...
                if len(parts) == 2:
                    ...
                    if votes_str.isdigit():
                        ...
                        known_parties = [
                            ...
                            'Green', 'Libertarian', 'Reform', 'Non- Partisan',
                            'Nonpartisan', 'Petition', 'Pawling Values', "PK's Choice"
                        ]
                        ...
                        # e.g., "Eric Eckley Democratic 1,106"
...
def main():
    """Extract Dutchess County election results to JSON."""
    project_root = Path(__file__).parent.parent
    pdf_path = project_root / 'data' / 'dutchess-2025-results.pdf'
    output_path = project_root / 'data' / 'raw' / 'dutchess_2025.json'
